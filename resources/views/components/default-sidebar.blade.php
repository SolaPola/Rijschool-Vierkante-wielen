<div class="w-full md:w-64 bg-white rounded-lg shadow-md p-4">
    <nav class="space-y-1">
        <!-- Default Menu Items -->
        <a href="{{ route('dashboard') }}" class="block px-4 py-3 rounded-lg {{ request()->routeIs('dashboard') ? 'bg-navy-600 text-white font-medium' : 'text-gray-700 hover:bg-navy-50 hover:text-navy-700' }}">
