...
<head>
    ...
    <title>Instructor Dashboard - Rijschool Vierkante Wielen</title>
...
<body class="bg-gray-50">
    ...
    <div class="container mx-auto px-4 py-6 flex flex-col md:flex-row gap-6">
        ...
        <div class="w-full md:w-64 bg-white rounded-lg shadow-md p-4">
            <nav class="space-y-1">
                <a href="{{ route('instructor.dashboard') }}" class="block px-4 py-3 rounded-lg bg-navy-600 text-white font-medium">
